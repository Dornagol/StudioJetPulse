    ...
    <header className="container mx-auto px-4 py-8">
      ...
      <div className="hover:scale-105 transition-transform duration-300">
        ...
        <button
          ...
          className="relative top-1.5 inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-teal-300 to-lime-300 group-hover:from-white group-hover:to-gray-500 dark:text-white dark:hover:text-gray-900 focus:ring-4 focus:outline-none focus:ring-lime-200 dark:focus:ring-lime-800">
